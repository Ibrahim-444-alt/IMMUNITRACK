...
<head>
    ...
    <title>Immunitrack|Admin dashboard</title>
    <!-- ======= Styles ====== -->
                        ...
                        <?php
                            ...
                            foreach($result as $row)
                            {
                                ...
                                "<tr>
                                    ...
                                    if($row['status']=="hide")
                                    {
                                        echo "<a href='show_feedback.php?id=$row[id]' class='btnactivate'>Show</a>"; 
                                    }
                                    else
                                    {
                                        echo "<a href='hide_feedback.php?id=$row[id]' class='btndeactivate'>Hide</a>"; 
                                    }   
                                    "</td>
                                </tr>";
                            }
